...
from configs.dbConfig import FETCH_DEVELOPER_TO_WHOM_EMAIL_WAS_SENT_3_WEEKS_AGO, FETCH_DEVELOPER_TO_WHOM_EMAIL_WAS_SENT_3_WEEKS_AGO_FROM_A_COMPANY, FETCH_PEOPLE_TO_WHOM_EMAIL_WAS_SENT_3_WEEKS_AGO, FETCH_RECRUITERS_TO_WHOM_EMAIL_WAS_NOT_SEND, FETCH_RECRUITERS_TO_WHOM_EMAIL_WAS_NOT_SEND_FROM_A_COMPANY, FETCH_RECRUITERS_TO_WHOM_EMAIL_WAS_SENT_3_WEEKS_AGO, FETCH_RECRUITERS_TO_WHOM_EMAIL_WAS_SENT_3_WEEKS_AGO_FROM_A_COMPANY, FETCH_TEACHERS_TO_WHOM_EMAIL_WAS_SENT_3_WEEKS_AGO
...
def getSQLCommand():
    if SEND_EMAILS_TO_SPECIFIC_COMPANIES:
        ...
        if FETCH_RECRUITERS:
            return FETCH_PEOPLE_TO_WHOM_EMAIL_WAS_SENT_3_WEEKS_AGO.format(TABLE_NAME)
        elif FETCH_TEACHERS:
